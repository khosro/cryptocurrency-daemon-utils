...
powershell -ExecutionPolicy ByPass -File ".\run-debug-NBXplorer.ps1" --conf="%Btcpay_Data_Home%\NBXplorer\NBXplorer.config"   -regtest --chains "btc,ltc" --datadir "%Btcpay_Data_Home%\NBXplorer\data" %*
